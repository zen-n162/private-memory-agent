...
def _chat_options_from_payload(payload: ChatQueryRequest, request: Request) -> ChatConsoleOptions:
    return ChatConsoleOptions(
        ...
        max_capability_steps=payload.max_capability_steps,
        max_replans=payload.max_replans,
        max_runtime_seconds=payload.max_runtime_seconds,
        max_model_calls=payload.max_model_calls,
        max_candidates_per_capability=payload.max_candidates_per_capability,
        max_evidence_sent_to_answer=payload.max_evidence_sent_to_answer,
