  ...
  <script>
    ...
    function renderTemporalDiagnostics(diagnostics) {
      ...
      renderKv(tracePanel, {
        ...
        date_range_status: diagnostics.date_range_status,
        date_scope_strategy: diagnostics.date_scope_strategy,
        open_ended_temporal_query: diagnostics.open_ended_temporal_query,
        inferred_search_range_start: diagnostics.inferred_search_range_start,
        inferred_search_range_end: diagnostics.inferred_search_range_end,
        date_scope_warning: diagnostics.date_scope_warning || "none",
        ...
        event_subtype: diagnostics.event_subtype || "none",
        ...
        final_candidate_dates: diagnostics.final_candidate_dates || [],
        ...
        chunks_scanned: diagnostics.chunks_scanned,
        chunk_size: diagnostics.chunk_size,
        candidates_before_pruning: diagnostics.candidates_before_pruning,
        candidate_dates_before_pruning: diagnostics.candidate_dates_before_pruning,
        candidates_after_pruning: diagnostics.candidates_after_pruning,
        candidate_dates_after_pruning: diagnostics.candidate_dates_after_pruning,
        ...
        evidence_count_by_source: diagnostics.evidence_count_by_source || {},
        dated_evidence_count: diagnostics.dated_evidence_count,
        undated_evidence_count: diagnostics.undated_evidence_count,
        evidence_to_candidate_date_conversion_rate: diagnostics.evidence_to_candidate_date_conversion_rate,
        performance_timing_by_stage: diagnostics.performance_timing_by_stage || {},
        open_ended_fast_mode: diagnostics.open_ended_fast_mode,
        stage_1_candidate_count: diagnostics.stage_1_candidate_count,
        expanded_to_all_memory: diagnostics.expanded_to_all_memory,
        expansion_reason: diagnostics.expansion_reason || "none",
        max_chunks: diagnostics.max_chunks || "none",
        chunk_limited: diagnostics.chunk_limited,
        max_candidate_dates_total: diagnostics.max_candidate_dates_total,
        max_evidence_per_date: diagnostics.max_evidence_per_date,
        max_semantic_candidates: diagnostics.max_semantic_candidates || "none",
